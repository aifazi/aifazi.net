...
export const THEMES: Record<ThemeId, Theme> = {
  ...
  ice: {
    ...
    colors: {
      ...
      warning: '#b45309',
      info: '#0284c7',
      divider: 'rgba(2,132,199,0.10)',
      link: '#0891b2',
      sale: '#ea580c',
      star: '#d97706',
      onAccent: '#ffffff',
      overlay: 'rgba(10,25,40,0.45)',
    },
  },
  paper: {
    id: 'paper',
    ...
    colors: {
      ...
      accent2: '#1a3a6c',
      danger: '#b91c1c',
      border: 'rgba(196,26,26,0.20)',
      success: '#16a34a',
      warning: '#b45309',
      info: '#0e7490',
      divider: 'rgba(196,26,26,0.10)',
      link: '#2a5db0',
      sale: '#c87400',
      star: '#a16207',
      onAccent: '#ffffff',
  ...
  minecraft: {
    ...
    colors: {
      ...
      accent2: '#2a9dd6',
      danger: '#f87171',
      border: 'rgba(90,212,39,0.22)',
      success: '#5ad427',
      warning: '#fbbf24',
      info: '#38bdf8',
      divider: 'rgba(90,212,39,0.10)',
      link: '#2a9dd6',
      sale: '#d97706',
      star: '#ffd700',
      onAccent: '#0a1a05',
  ...
  'ember-dark': {
    ...
    colors: {
      ...
      warning: '#fbbf24',
      info: '#38bdf8',
      divider: 'rgba(255,87,34,0.10)',
      link: '#ff9800',
      sale: '#ffb74d',
      star: '#ffd700',
      onAccent: '#1c0d05',
      overlay: 'rgba(16,6,5,0.62)',
    },
  },
  'cobalt-dark': {
    id: 'cobalt-dark',
  ...
  'honey-dark': {
    ...
    colors: {
      ...
      warning: '#fbbf24',
      info: '#38bdf8',
      divider: 'rgba(255,179,0,0.10)',
      link: '#ff8f00',
      sale: '#ffc107',
      star: '#ffd700',
      onAccent: '#1a1202',
      overlay: 'rgba(13,10,2,0.62)',
    },
  },
  'violet-dark': {
    id: 'violet-dark',
  ...
  'teal-dark': {
    ...
    colors: {
      ...
      warning: '#fbbf24',
      info: '#38bdf8',
      divider: 'rgba(45,212,191,0.10)',
      link: '#5eead4',
      sale: '#fb923c',
      star: '#ffd700',
      onAccent: '#00201b',
      overlay: 'rgba(3,18,16,0.62)',
    },
  },
}
...
export const THEME_IDS: ThemeId[] = [
  ...
  'ice', 'paper', 'mario', 'minecraft', 'sonic',
  'ember-dark', 'cobalt-dark', 'slate-dark', 'honey-dark',
  'violet-dark', 'teal-dark',
]
...
const WEB_THEME_MAP: Record<string, ThemeId> = {
  ...
  mario: 'mario', 'mario-light': 'pacman-light',
...
export const THEME_PAIRS: Record<ThemeId, ThemeId> = {
  ...
  ice: 'sonic',
  paper: 'brutalist-dark',
  mario: 'pacman-light',
  minecraft: 'terminal-light',
  sonic: 'ice',
  'ember-dark': 'lava-light',
  'cobalt-dark': 'ocean-light',
  'slate-dark': 'light',
  'honey-dark': 'amber-light',
  'violet-dark': 'midnight-light',
  'teal-dark': 'aurora-light',
}
