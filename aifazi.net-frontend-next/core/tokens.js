...
// Tints derive from the active theme accent so light themes stay readable.
export const VARIANTS = {
  success: {
    color:  'var(--green)',
    bg:     'color-mix(in srgb, var(--green) 8%, transparent)',
    border: 'color-mix(in srgb, var(--green) 30%, transparent)',
    glow:   'color-mix(in srgb, var(--green) 35%, transparent)',
    icon:   '✓',
    label:  'SUCCESS',
  },
  error: {
    ...
    glow:   'color-mix(in srgb, var(--red) 35%, transparent)',
    icon:   '✕',
    label:  'ERROR',
  },
  warning: {
    ...
    glow:   'color-mix(in srgb, var(--orange) 35%, transparent)',
    icon:   '⚠',
    label:  'WARNING',
  },
  info: {
    color:  'var(--cyan)',
    bg:     'color-mix(in srgb, var(--cyan) 8%, transparent)',
    border: 'color-mix(in srgb, var(--cyan) 30%, transparent)',
    glow:   'color-mix(in srgb, var(--cyan) 35%, transparent)',
    icon:   'ℹ',
    label:  'INFO',
  },
  danger: {
