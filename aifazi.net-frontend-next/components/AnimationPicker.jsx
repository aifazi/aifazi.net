  ...
  return (
    <button
      ...
      style={{
        ...
        background: isSelected ? 'rgba(0,255,136,0.1)' : 'var(--bg3)',
        border: `1px solid ${isSelected ? 'var(--green)' : 'var(--border)'}`,
        borderRadius: 8, transition: 'all 0.2s', width: '100%',
        boxShadow: isSelected ? '0 0 12px rgba(0,255,136,0.2)' : 'none',
      }}
      onMouseEnter={e => { e.currentTarget.style.borderColor = isSelected ? 'var(--green)' : 'rgba(0,255,136,0.4)'; setKey(k => k + 1) }}
    ...
    >
      ...
      <div style={{ width: 36, height: 36, display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' }}>
        <div
          ...
          style={{
            ...
            border: `1px solid ${isSelected ? 'var(--green)' : 'rgba(0,255,136,0.3)'}`,
            display: 'flex', alignItems: 'center', justifyContent: 'center',
            fontSize: 14, color: isSelected ? '#000' : 'var(--green)',
            animation: anim.preview,
            boxShadow: isSelected ? '0 0 8px rgba(0,255,136,0.5)' : 'none',
          }}
        >
          {anim.icon}
        </div>
      ...
      {anim.engine === 'gsap' && (
        <span style={{ fontFamily: 'var(--font-mono)', fontSize: 7, letterSpacing: 1.5, color: isSelected ? '#000' : 'var(--cyan)', background: isSelected ? 'var(--green)' : 'rgba(0,212,255,0.08)', padding: '1px 5px', borderRadius: 8 }}>
          GSAP
        </span>
      )}
      {isSelected && (
  ...
  return (
    <>
      ...
      <div style={{
        ...
        width: 360, borderLeft: '1px solid rgba(0,212,255,0.15)',
          ...
          <div style={{ display: 'flex', gap: 8, marginBottom: 8 }}>
            ...
            <button
              ...
              style={{
                ...
                transition: 'all 0.2s', boxShadow: selected ? '0 0 16px rgba(0,255,136,0.3)' : 'none',
              }}
