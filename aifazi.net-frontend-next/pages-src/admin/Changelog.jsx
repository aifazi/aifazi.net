...
const ROADMAP = [
  ...
  },
  {
    ...
    items: [
      ...
      { type: 'todo', title: '#19 — DatabaseGUI read-only for editor/moderator', detail: 'getRole() check disables write/execute UI for non-admin staff roles.' },
      { type: 'todo', title: '#20 — next/image + CDN for WebP & responsive images', detail: 'Add cdn.aifazi.net to next.config.js images.domains. Swap <img> → <Image> sitewide.' },
      ...
      { type: 'todo', title: 'Role-based section access', detail: 'Granular permissions: e.g. editors can see Posts but not Staff or Audit Log.' },
