    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      {d.revenue_by_day?.length > 0 && (
        <div style={{ background: 'var(--bg2)', border: '1px solid var(--border)', borderRadius: 12, padding: 16 }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12, flexWrap: 'wrap', gap: 8 }}>
            ...
            <span style={{ fontFamily: MONO, fontSize: 11, color: 'var(--muted)' }}>{d.revenue_by_day.length} days</span>
          </div>
      ...
      <div style={{ background: 'var(--bg2)', border: '1px solid var(--border)', borderRadius: 12, padding: 18 }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
          <div style={{ fontFamily: MONO, fontSize: 11, letterSpacing: 3, color: 'var(--muted)' }}>RECENT ORDERS</div>
          <button onClick={() => onNavigate?.('orders')} style={{ background: 'none', border: '1px solid var(--border)', color: C, fontSize: 11, letterSpacing: 1, padding: '4px 10px', borderRadius: 6, cursor: 'pointer', fontFamily: MONO }}>VIEW ALL →</button>
        </div>
