            ...
            <div style={{ display: 'grid', gap: 6 }}>
              {d.recent_orders.map(o => (
                <div key={o.order_number} style={{ background: 'var(--bg3)', border: '1px solid var(--border)', borderRadius: 8, padding: '8px 12px', display: 'flex', alignItems: 'center', gap: 8 }}>
                  ...
                  <span style={{ fontFamily: MONO, fontSize: 8, letterSpacing: 1, padding: '1px 7px', borderRadius: 10, background: 'rgba(0,255,136,.08)', border: '1px solid rgba(0,255,136,.3)', color: G }}>{o.status}</span>
                  <div style={{ flex: 1 }} />
