        ...
        <div style={{ padding:16, borderBottom:'1px solid var(--border)', display:'flex', gap:10, justifyContent:'space-between', flexWrap:'wrap' }}>
          ...
          <div style={{ display:'flex', gap:8, flexWrap:'wrap' }}>
            ...
            <button disabled={saving} onClick={save}
              style={{ background:'color-mix(in srgb, var(--green) 12%, transparent)', border:'1px solid color-mix(in srgb, var(--green) 45%, transparent)', color:'var(--green)', borderRadius:6, padding:'9px 16px', fontFamily:'var(--font-mono)', cursor:saving?'not-allowed':'pointer', opacity:saving ? 0.65 : 1 }}>
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 5, flexWrap: 'wrap', fontFamily: 'var(--font-mono)', fontSize: 7 }}>
          ...
          {b.style && b.style !== 'banner' && (
            <span style={{ color: 'var(--cyan)', background: 'color-mix(in srgb, var(--cyan) 10%, transparent)', border: '1px solid color-mix(in srgb, var(--cyan) 25%, transparent)', padding: '1px 6px', borderRadius: 3 }}>
      ...
      <div style={{ display: 'flex', gap: 4, flexShrink: 0 }}>
        <button onClick={() => onEdit(b)} title="Edit"
          style={{ padding: '5px 9px', borderRadius: 5, fontFamily: 'var(--font-mono)', fontSize: 11,
            background: isEditing ? 'color-mix(in srgb, var(--cyan) 15%, transparent)' : 'transparent',
...
function AnnouncementsPanel() {
  ...
  const TYPES = [
    { id: 'info',    label: 'Info',    icon: '\u2139\ufe0f', color: '#00d4ff', glow: 'color-mix(in srgb, var(--cyan) 20%, transparent)'  },
    { id: 'warning', label: 'Warning', icon: '\u26a0\ufe0f', color: '#ffd700', glow: 'rgba(255,215,0,0.2)'   },
    { id: 'success', label: 'Success', icon: '\u2705',        color: '#00ff88', glow: 'color-mix(in srgb, var(--green) 20%, transparent)'  },
  ...
  return (
    <div style={{ maxWidth: 820, padding: isMobile ? '16px' : '28px 32px' }}>
      <style>{`
        ...
        .ann-inp:focus { border-color:var(--cyan)!important; box-shadow:0 0 0 2px color-mix(in srgb, var(--cyan) 10%, transparent)!important; }
            ...
            <button
              ...
              style={{
                ...
                boxShadow: (!saving && form.message.trim())
                  ? '0 0 16px ' + (editId ? activeType.glow : 'color-mix(in srgb, var(--green) 28%, transparent)')
                  : 'none',
              }}
            >
          ...
          <div style={{ display: 'grid', gap: 6 }}>
            {filtered.map((s, i) => (
              <div key={i} style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '10px 14px', background: 'var(--bg3)', border: '1px solid var(--border)' }}>
                <div style={{ width: 28, height: 28, borderRadius: '50%', background: 'color-mix(in srgb, var(--green) 10%, transparent)', border: '1px solid color-mix(in srgb, var(--green) 30%, transparent)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 12, flexShrink: 0 }}>
  ...
  return (
    <div style={{ padding: isMobile ? 16 : 32, maxWidth: 640 }}>
      ...
      <button onClick={download} disabled={downloading} style={{
        ...
        background: downloading ? 'color-mix(in srgb, var(--green) 5%, transparent)' : 'color-mix(in srgb, var(--green) 12%, transparent)',
        border: `1px solid ${downloading ? 'color-mix(in srgb, var(--green) 20%, transparent)' : 'color-mix(in srgb, var(--green) 50%, transparent)'}`,
