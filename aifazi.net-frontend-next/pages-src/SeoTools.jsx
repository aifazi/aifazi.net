    ...
    <div>
      ...
      {result && (
        <div>
          ...
          {result.targetResult && (
            <div style={{ background: 'var(--bg3)', border: '1px solid rgba(0,255,136,0.3)', padding: '16px 20px', marginBottom: 20 }}>
...
const S = {
  ...
  tabActive:    { background: 'rgba(0,255,136,0.1)', color: 'var(--green)', borderColor: 'rgba(0,255,136,0.4)' },
