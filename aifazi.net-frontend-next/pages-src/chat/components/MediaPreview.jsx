...
function PlainLinkChip({ url }) {
  const domain = getDomain(url)
  return (
    <a href={url} target="_blank" rel="noopener noreferrer" className="chat-link-chip"
      style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '6px 10px', borderRadius: T.radius,
        border: `${T.borderW} solid ${T.border}`, background: T.surface, textDecoration: 'none', color: T.text, maxWidth: 420 }}>
