...
// Theme id space lives in core/themeCatalog.js (VALID_THEMES, LIGHT_THEMES,
// THEME_PAIRS) — imported above so the catalog is never duplicated.
      ...
      <EditProvider initialContent={initialContent}>
        ...
        <ForumProvider>
          ...
          <style>{`
            ...
            [data-surface-style="terminal"] body { background-color: var(--bg) !important; background-image: repeating-linear-gradient(0deg, color-mix(in srgb, var(--green) 7%, transparent) 0 1px, transparent 1px 4px) !important; background-size: 100% 4px !important; }
            [data-surface-style="neon-stage"] body { background: radial-gradient(600px 300px at 15% 0%, color-mix(in srgb, var(--cyan) 10%, transparent), transparent 60%), radial-gradient(600px 300px at 85% 10%, color-mix(in srgb, var(--green) 8%, transparent), transparent 60%), var(--bg) !important; }
            [data-surface-style="dashboard"] body { background-color: var(--bg) !important; background-image: linear-gradient(color-mix(in srgb, var(--cyan) 6%, transparent) 1px, transparent 1px), linear-gradient(90deg, color-mix(in srgb, var(--cyan) 4%, transparent) 1px, transparent 1px) !important; background-size: 24px 24px !important; }
          `}</style>
        </ForumProvider>
        </ErrorBoundary>
      </EditProvider>
