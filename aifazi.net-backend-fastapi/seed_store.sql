...
BEGIN
  ...
  INSERT INTO public.store_products
    (category_id, slug, name, sku, description, price_cents, type, stock_qty, track_inventory, active, featured, sort_order, compare_at_cents)
  VALUES
    -- Digital Goods
    ...
    (digital_id, 'demo-premium-config-pack', 'Premium Server Config Pack', 'CFG-PRO',
     ...
     3500, 'digital', 999, FALSE, TRUE, TRUE, 3, NULL),
    ...
    (merch_id, 'demo-aifazi-hoodie', 'AIFAZI RP Limited Hoodie', 'AF-HOOD',
     ...
     4999, 'physical', 100, TRUE, TRUE, TRUE, 1, 5999),
    (merch_id, 'demo-aifazi-sticker-pack', 'AIFAZI Sticker Pack (5-pack)', 'AF-STK',
     ...
     999, 'physical', 500, TRUE, TRUE, FALSE, 2, NULL),
    ...
    (service_id, 'demo-whitelist-review', 'Priority Whitelist Review', 'WL-PRIO',
     ...
     500, 'service', 9999, TRUE, TRUE, TRUE, 1, NULL),
    (service_id, 'demo-staff-consult', '1-Hour Staff Consult', 'CONS-1H',
     ...
     2500, 'service', 50, TRUE, TRUE, FALSE, 2, NULL),
    ...
    (vip_id, 'demo-donator-role', 'Donator Role (Lifetime)', 'DON-LIFE',
     ...
     1500, 'digital', 500, TRUE, TRUE, TRUE, 1, NULL)
